...
go_rundir="cd Eder_B"
python_cmd="python -i eder_v2.py"
other_opt=""
while [[ $# > 0 ]];
do
    case "$1" in
...
###
cd ../Eder_B
# sudo python eder_v2.py -f 45e6 -b MB1 -u SNFP19038 -r BFM06005 -x RX -p 5220
sudo python eder_v2.py -f 45e6 -b MB1 -u SNSP220028 -r BFM06009 -x RX -p 5220
